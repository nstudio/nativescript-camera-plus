declare class QBAlbumCell extends UITableViewCell {
  ...
  ): QBAlbumCell; // inherited from UIAppearance
...
declare class QBAssetCell extends UICollectionViewCell {
  ...
  static appearanceForTraitCollectionWhenContainedIn(
    trait: UITraitCollection,
    ContainerClass: typeof NSObject
  ): QBAssetCell; // inherited from UIAppearance
...
declare class QBCheckmarkView extends UIView {
  ...
  static appearanceForTraitCollectionWhenContainedIn(
    trait: UITraitCollection,
    ContainerClass: typeof NSObject
  ): QBCheckmarkView; // inherited from UIAppearance
...
declare class QBSlomoIconView extends UIView {
  ...
  static appearanceForTraitCollectionWhenContainedIn(
    trait: UITraitCollection,
    ContainerClass: typeof NSObject
  ): QBSlomoIconView; // inherited from UIAppearance
...
declare class QBVideoIconView extends UIView {
  ...
  static appearanceForTraitCollectionWhenContainedIn(
    trait: UITraitCollection,
    ContainerClass: typeof NSObject
  ): QBVideoIconView; // inherited from UIAppearance
...
declare class QBVideoIndicatorView extends UIView {
  ...
  static appearanceForTraitCollectionWhenContainedIn(
    trait: UITraitCollection,
    ContainerClass: typeof NSObject
  ): QBVideoIndicatorView; // inherited from UIAppearance
